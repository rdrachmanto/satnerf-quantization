...
DFC2019_dir="/data/rdr78068/satnerf-base/datasets/DFC2019"
root_dir="/data/rdr78068/satnerf-base/datasets/root_dir/crops_rpcs_ba_v2/$aoi_id"
cache_dir="/data/rdr78068/satnerf-base/datasets/cache_dir/crops_rpcs_ba_v2/"$aoi_id"_ds"$downsample_factor
img_dir=$DFC2019_dir/"Track3-RGB-crops/"$aoi_id"-Copy1"
out_dir="/data/rdr78068/satnerf-base/nerf_output-copy1"
