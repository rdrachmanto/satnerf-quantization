...
class RandomEntropyCalibrator(trt.IInt8EntropyCalibrator2):
    def __init__(self, cache_file, num_batches=5, seed=42):
        ...
        self.shape_xyz = (1310720, 3)
        self.shape_sun_dir = (1310720, 3)
        self.shape_t = (1310720, 4)
    ...
    def get_batch_size(self):
        return 1  # We simulate batchless input
    ...
    def get_batch(self, names):
        ...
        t = self.rng.integers(0, 18, size=self.shape_t).astype(np.float32)
