...
def main(args):
    ...
    for i in range(network.num_layers):
        ...
        chosen_precision = trt.DataType.HALF if args.precision == "fp16" else trt.DataType.INT8
    ...
    # === Save engine to file ===
    with open(f"/data/rdr78068/satnerf-base/generated/model_{args.precision}.trt", "wb") as f:
